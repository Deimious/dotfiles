...
if ( &t_Co >= 255 || $TERM =~? "256color" )
  hi Normal         term=none		cterm=none	ctermfg=15	ctermbg=233
  hi Boolean        term=none		cterm=none	ctermfg=4		ctermbg=none
  hi Character      term=none		cterm=none	ctermfg=5		ctermbg=none
  hi Comment        term=none		cterm=none	ctermfg=7		ctermbg=233
  hi Conditional    term=none		cterm=none	ctermfg=5		ctermbg=none
  hi Constant       term=none		cterm=none	ctermfg=5		ctermbg=none
  hi Cursor         term=none		cterm=none	ctermfg=233	ctermbg=5
  ...
  hi Directory      term=none		cterm=none	ctermfg=5		ctermbg=none
  hi ErrorMsg       term=none		cterm=none	ctermfg=4		ctermbg=none
  hi Error          term=none		cterm=none	ctermfg=1		ctermbg=233
  ...
  hi MatchParen     term=none		cterm=none	ctermfg=0		ctermbg=5
  ...
  hi Type           term=none		cterm=none	ctermfg=12		ctermbg=none
  hi Underlined     term=none		cterm=none	ctermfg=7		ctermbg=none
  hi VertSplit      term=none		cterm=none	ctermfg=5		ctermbg=233
