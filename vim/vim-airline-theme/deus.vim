...
let s:N1 = [ '#282C34', '#98C379', 0, 5 ]
let s:N2 = [ '#ABB2BF', '#3E4452', 8, 0 ]
let s:N3 = [ '#98C379', '#282C34', 5, '' ]
...
let s:I1 = [ '#282C34', '#61AFEF', 7, 2 ]
let s:I2 = s:N2
let s:I3 = [ '#61AFEF', '#282C34', 2, '' ]
