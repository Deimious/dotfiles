...
if ( &t_Co >= 255 || $TERM =~? "256color" )
  hi Normal         term=none cterm=none ctermfg=7   ctermbg=233
  hi Boolean        term=none cterm=none ctermfg=2  ctermbg=none
  hi Character      term=none cterm=none ctermfg=5   ctermbg=none
  hi Comment        term=none cterm=none ctermfg=0  ctermbg=233
  hi Conditional    term=none cterm=none ctermfg=5  ctermbg=none
  hi Constant       term=none cterm=none ctermfg=5   ctermbg=none
  hi Cursor         term=none cterm=none ctermfg=233  ctermbg=2
  hi CursorLine     term=none cterm=none ctermfg=none ctermbg=234
  hi CursorLineNr   term=none cterm=none ctermfg=15  ctermbg=233
  hi CursorColumn   term=none cterm=none ctermfg=none ctermbg=233
  hi Debug          term=none cterm=none ctermfg=3  ctermbg=none
  hi Define         term=none cterm=none ctermfg=4   ctermbg=none
  hi Delimiter      term=none cterm=none ctermfg=6   ctermbg=none
  hi DiffAdd        term=none cterm=none ctermfg=6   ctermbg=236
  hi DiffChange     term=none cterm=none              ctermbg=236
  hi DiffDelete     term=none cterm=none ctermfg=0  ctermbg=237
  hi DiffText       term=none cterm=none ctermfg=3  ctermbg=7
  hi Directory      term=none cterm=none ctermfg=7  ctermbg=none
  hi ErrorMsg       term=none cterm=none ctermfg=4   ctermbg=none
  hi Error          term=none cterm=none ctermfg=2  ctermbg=233
  hi Exception      term=none cterm=none ctermfg=2  ctermbg=none
  hi Float          term=none cterm=none ctermfg=7  ctermbg=none
  hi FoldColumn     term=none cterm=none ctermfg=2   ctermbg=235
  ...
  hi Keyword        term=none cterm=none ctermfg=2   ctermbg=none
  hi Label          term=none cterm=none ctermfg=2  ctermbg=none
  hi LineNr         term=none cterm=none ctermfg=7  ctermbg=233
  hi MatchParen     term=none cterm=none ctermfg=0  ctermbg=2
  hi Macro          term=none cterm=none ctermfg=2   ctermbg=none
  hi ModeMsg        term=none cterm=none ctermfg=2  ctermbg=none
  hi MoreMsg        term=none cterm=none ctermfg=5   ctermbg=none
  ...
  hi StorageClass   term=none cterm=none ctermfg=1  ctermbg=none
  ...
  hi Tag            term=none cterm=none ctermfg=2  ctermbg=none
  hi Title          term=none cterm=none ctermfg=4  ctermbg=none
  hi Todo           term=none cterm=none ctermfg=5   ctermbg=235
  hi Typedef        term=none cterm=none ctermfg=5  ctermbg=none
  ...
  hi WildMenu       term=none cterm=none ctermfg=5   ctermbg=none
endif
