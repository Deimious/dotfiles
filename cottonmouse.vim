...
if ( &t_Co >= 255 || $TERM =~? "256color" )
  ...
  hi Error          term=none cterm=none ctermfg=108  ctermbg=0
  ...
  hi Folded         term=none cterm=none ctermfg=60   ctermbg=0
  ...
  hi LineNr         term=none cterm=none ctermfg=247  ctermbg=0
  ...
  hi NonText        term=none cterm=none ctermfg=237  ctermbg=0
  ...
  hi VertSplit      term=none cterm=none ctermfg=60  ctermbg=0
